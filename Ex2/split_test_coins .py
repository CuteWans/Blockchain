...
if __name__ == '__main__':
    ...
    txid_to_spend = (
        'e1ef9efd3b3e224a8226281d46ad0d11c2d00fe7c5e7172ef87e371369d77fde')
    utxo_index = 1
    n=10 # number of outputs to split the input into
    ######################################################################

    split_coins(amount_to_send, txid_to_spend, utxo_index, n)
    # https://live.blockcypher.com/btc-testnet/tx/16cdf1751652cd0c099ea31a6bc016043b27e159a83e6ad19e1a86b2f39a9449/